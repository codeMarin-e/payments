...
return [
     ...
     */
    'install_behavior' => env('MARINAR_PAYMENTS_INSTALL_BEHAVIOR', env('MARINAR_INSTALL_BEHAVIOR', true)),
     ...
     * 2 - keep everything
     */
    'delete_behavior' => env('MARINAR_PAYMENTS_DELETE_BEHAVIOR', env('MARINAR_DELETE_BEHAVIOR', false)),
     ...
     */
    'addons' => [
        // @HOOK_PAYMENTS_CONFIGS_ADDONS
    ],
    // @HOOK_PAYMENTS_CONFIGS
];
